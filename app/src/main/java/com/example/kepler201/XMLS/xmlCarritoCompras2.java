...
public class xmlCarritoCompras2 extends SoapSerializationEnvelope {
    String Comentario="";
    ...
    public void write(XmlSerializer writer) throws IOException {
        ...
        writer.text(formatNumberCurrency(DescuentoPro));
        ...
        for (int i = 0; i<listaCarShoping.size();i++){
            ...
            writer.text(formatNumberCurrency(String.valueOf(listaCarShoping.get(i).getPrecio())));
            writer.endTag(tem, "k_precio");

            writer.startTag(tem, "k_monto");
            writer.text(formatNumberCurrency(String.valueOf(listaCarShoping.get(i).getMonto())));
            writer.endTag(tem, "k_monto");
